    ...
    <div className="min-h-screen flex" style={{ background: 'var(--bg-base)' }}>
      ...
      >
        ...
        <div className="absolute bottom-0 left-0 w-64 h-64 rounded-full blur-3xl opacity-10 pointer-events-none"
          style={{ background: 'radial-gradient(circle, #34d399, #22d3ee)', transform: 'translate(-30%, 30%)' }} />
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-sm">
          ...
          <h2 className="font-display font-semibold text-2xl mb-2" style={{ color: 'var(--text-primary)' }}>
            Welcome back
          </h2>
          ...
          <button
            ...
            onMouseEnter={(e) => { if (!loading) { e.currentTarget.style.borderColor = 'rgba(34,211,238,0.4)'; e.currentTarget.style.boxShadow = '0 0 0 3px rgba(34,211,238,0.08)'; } }}
          ...
          >
            ...
            {loading ? 'Redirigiendo a Google…' : 'Continue with Google'}
          </button>
